//Imran Sabur
//Nov 5, 2019
//Imran Sabur added locate(); and added InternalHashSecond()
...
class DoubleProb {
 public:
  ...
  explicit DoubleProb(size_t size = 101) : array_(NextPrime(size)),collision_counter(0)
    { MakeEmpty(); }
